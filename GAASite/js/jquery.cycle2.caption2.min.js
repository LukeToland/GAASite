...
(function(a){
	...
	{if(c.captionPlugin!=="caption2")return;a.each(["caption","overlay"],function(){
		var a=this+"Fx",b=c[a+"Out"]||"hide",f=d[this+"Template"],g=c.API.getComponent(this),h=c[a+"Sel"],i=c.speed,j;c.sync&&(i=i/2),j=h?g.find(h):g,g.length&&f?(b=="hide"&&(i=0),j[b](i,function(){
			var k=c.API.tmpl(f,d,c,e);g.html(k),j=h?g.find(h):g,h&&j.hide(),b=c[a+"In"]||"show",j[b](i)})):g.hide()})}
